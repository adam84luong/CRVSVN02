...
{
    public class RetrieveCardTransactionsServiceCommand : ProviderServiceCommandBase<RetrieveTransactionRequest, RetrieveTransactionResponse>
    {
        ...
        public RetrieveCardTransactionsServiceCommand(IProviderFactory providers) : base(providers) { }
